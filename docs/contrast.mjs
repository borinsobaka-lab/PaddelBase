...
const T = {
  // Нейтралы без подкраски: в референсе серый — именно серый, а не «тёплый»
  // или «холодный». Любая хроматичность здесь сразу читается как посторонний
  // оттенок рядом с чистым синим.
  canvas: [0.962, 0.002, 264],
  surface: [1, 0, 0],
  sunken: [0.945, 0.003, 264],
  border: [0.902, 0.004, 264],
  borderStrong: [0.640, 0.008, 264],

  text: [0.205, 0.006, 264],
  textSecondary: [0.448, 0.008, 264],
  muted: [0.516, 0.009, 264],
  faint: [0.618, 0.008, 264],

  accent: [0.545, 0.186, 261],
  accentSoft: [0.958, 0.018, 261],
  accentInk: [1, 0, 0],

  ball: [0.858, 0.158, 88],
  ballInk: [0.330, 0.070, 70],
  ballSoft: [0.966, 0.040, 88],

  warn: [0.548, 0.128, 55],
  warnSoft: [0.960, 0.026, 68],
  danger: [0.548, 0.192, 22],
  dangerSoft: [0.950, 0.021, 20],
};
